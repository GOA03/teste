...
public class UsuarioModel {
	...
	// Construtor
	public void Usuario(int id, int ra, String nome, String senha, String token, boolean avisosEsportes,
			boolean avisosClima, boolean avisosTecnologia, boolean avisosSaude, boolean avisosEconomia) {
		this.id = id;
		this.ra = ra;
		this.nome = nome;
		this.senha = senha;
